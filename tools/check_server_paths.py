...
REQUIRED_VARIABLES = [
    ...
    "DIFFSYNTH_ROOT",
    "QWEN_VL_REPO",
    "THREED_FRONT_DATASET_ROOT",
    "THREED_FRONT_SCENE_ROOT",
    "THREED_FUTURE_MODEL_ROOT",
    "THREED_FUTURE_MODEL_INFO",
    "THREED_FRONT_TEXTURE_ROOT",
...
STAGE_HINTS = {
    ...
    "THREED_FRONT_DATASET_ROOT": "authoritative 3D-FRONT/3D-FUTURE dataset lock",
    "THREED_FRONT_SCENE_ROOT": "3D-FRONT scene JSON parsing",
    "THREED_FUTURE_MODEL_ROOT": "3D-FUTURE split model directory container",
    "THREED_FUTURE_MODEL_INFO": "3D-FUTURE category/model_info lookup",
    "THREED_FRONT_TEXTURE_ROOT": "3D-FRONT texture rendering inputs",
